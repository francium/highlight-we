...
class BaseComponent extends _react2.default.Component {

  constructor(props) {
    super(props);
    this.logger = new _logger2.default(`highlight-we::${this.constructor.name}`);
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_util_logger__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__bootstrap__ = __webpack_require__(9);
...
function configureLogger() {
  ...
  switch ("production") {
    case 'development':
      __WEBPACK_IMPORTED_MODULE_0__common_util_logger__["default"].configure(__WEBPACK_IMPORTED_MODULE_0__common_util_logger__["default"].Level.Log);
      break;

    case 'production':
      __WEBPACK_IMPORTED_MODULE_0__common_util_logger__["default"].configure(__WEBPACK_IMPORTED_MODULE_0__common_util_logger__["default"].Level.Warn);
      break;

    default:
      __WEBPACK_IMPORTED_MODULE_0__common_util_logger__["default"].configure(__WEBPACK_IMPORTED_MODULE_0__common_util_logger__["default"].Level.Debug);
  }
}
...
function main() {
  ...
  const logger = new __WEBPACK_IMPORTED_MODULE_0__common_util_logger__["default"]('index');

  try {
    __WEBPACK_IMPORTED_MODULE_1__bootstrap___default()();
  } catch (err) {
    logger.error(err);
  }
}
...
// Needed for eslint ('render(<App/>...)'')
/* global document */

function bootstrap() {
  const logger = new _logger2.default('bootstrap');
  logger.debug('Bootstraping App');
  const root = document.createElement('div');
  root.id = 'highligh-we';
  document.body.appendChild(root);
  _reactDom2.default.render(_react2.default.createElement(_app2.default, null), document.getElementById('highligh-we'));
...
var _popupAction = __webpack_require__(6);

var _popupAction2 = _interopRequireDefault(_popupAction);

var _popupMode = __webpack_require__(7);

var _popupMode2 = _interopRequireDefault(_popupMode);
...
class App extends _baseComponent2.default {

  constructor(props) {
    super(props);

    this.storage = new _storage2.default(_config2.default.write_delay);
    this.highlighter = new _highlight2.default(document.body);
  ...
  async loadHighlights() {
    try {
      const data = await this.storage.get(_config2.default.storage_highlight_data_key);
      if (data) {
  ...
  registerListeners() {
    ...
    document.addEventListener('selectionchange', () => this.onSelectionChange(document.getSelection()));

    document.body.addEventListener('click', event => this.onDocumentBodyClick(event));

    window.addEventListener('beforeunload', event => this.onDoucmentUnload(event));
  }
  ...
  onDocumentBodyClick(event) {
    if (event.target.getAttribute('data-highlighted') === 'true') {
      ...
      this.setState({
        ...
        popupMode: _popupMode2.default.EditHighlight,
  ...
  onSelectionChange(selection) {
    ...
    if (!popupHidden) {
      ...
      this.setState({
        ...
        popupMode: _popupMode2.default.NewSelection
      });
    }
  ...
  onPopupAction(action, maybeValue) {
    switch (action) {
      case _popupAction2.default.DoHighlight:
        this.highlighter.doHighlight();
        this.storage.set(_config2.default.storage_highlight_data_key, this.highlighter.serialize()).then(result => this.logger.debug('Saved data to storage', result)).catch(error => this.logger.error('Error saving data to storage', error));
        break;

      case _popupAction2.default.DoNote:
        break;

      case _popupAction2.default.DoRemove:
      ...
      case _popupAction2.default.DoColorChange:
  ...
  viewPopup() {
    return !this.state.enabled || this.state.popupHidden ? false : _react2.default.createElement(_popup2.default, {
...
exports.default = App; /* global browser, document, window */
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_highlight_page__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_highlight_page___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_highlight_page__);
...
class Highlight {
  ...
  constructor(root) {
    this.root = root;
    this.highlighter = new __WEBPACK_IMPORTED_MODULE_0_highlight_page___default.a(root);
  }
...
/* harmony export (immutable) */ __webpack_exports__["default"] = Highlight;
 ...
 * @type {string[]}
 */
IGNORE_TAGS = ['SCRIPT', 'STYLE', 'SELECT', 'OPTION', 'BUTTON', 'OBJECT', 'APPLET', 'VIDEO', 'AUDIO', 'CANVAS', 'EMBED', 'PARAM', 'METER', 'PROGRESS'];
...
Highlighter.prototype.doHighlight = function (keepRange) {
    var range = dom(this.el).getRange(),
        wrapper = void 0,
        createdHighlights = void 0,
        normalizedHighlights = void 0,
        timestamp = void 0;
...
Highlighter.prototype.normalizeHighlights = function (highlights) {
    var normalizedHighlights = void 0;
...
Highlighter.prototype.mergeSiblingHighlights = function (highlights) {
    ...
    function shouldMerge(current, node) {
        return node && node.nodeType === NODE_TYPE.ELEMENT_NODE && haveSameColor(current, node) && self.isHighlight(node);
    }
...
var _iconPencil = __webpack_require__(34);

var _iconPencil2 = _interopRequireDefault(_iconPencil);

var _iconRemove = __webpack_require__(35);

var _iconRemove2 = _interopRequireDefault(_iconRemove);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

class Popup extends _baseComponent2.default {
  ...
  onColorChange(event) {
    ...
    this.onAction(_popupAction2.default.DoColorChange, event.target.value);
  ...
  viewMode() {
    switch (this.props.popupMode) {
      case _popupMode2.default.NewSelection:
        /* eslint-disable react/no-danger */
        return _react2.default.createElement(
          'div',
          { className: _popup2.default.actionButtonWrapper },
          _react2.default.createElement('button', {
            className: _popup2.default.actionButton,
            onClick: () => this.onAction(_popupAction2.default.DoHighlight),
            dangerouslySetInnerHTML: { __html: _iconPencil2.default }
          }),
          _react2.default.createElement(
            'select',
            {
              className: _popup2.default.colorSelector,
            ...
            _react2.default.createElement(
              'option',
              { value: 'rgb(255, 255, 123)' },
              'yellow'
            ),
            _react2.default.createElement(
              'option',
              { value: 'rgb(255, 180, 228)' },
              'pink'
            ),
            _react2.default.createElement(
              'option',
              { value: 'rgb(169, 255, 124)' },
              'green'
            ),
            _react2.default.createElement(
              'option',
              { value: 'rgb(124, 204, 255)' },
              'blue'
            )
          )
        );
      ...
      case _popupMode2.default.EditHighlight:
        /* eslint-disable react/no-danger */
        return _react2.default.createElement(
          'div',
          { className: _popup2.default.actionButtonWrapper },
          _react2.default.createElement('button', {
            className: _popup2.default.actionButton,
            onClick: () => this.onAction(_popupAction2.default.DoRemove),
            dangerouslySetInnerHTML: { __html: _iconRemove2.default }
          })
        );
      /* eslint-enable react/no-danger */
  ...
  render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: _popup2.default.popupContainer },
        this.viewMode()
      )
    );
  }
...
Popup.propTypes = {
  ...
  selectionBox: _propTypes2.default.shape({
    top: _propTypes2.default.number,
    left: _propTypes2.default.number,
    height: _propTypes2.default.number,
    width: _propTypes2.default.number
  }),
  popupMode: _propTypes2.default.string, // enum
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js??ref--2!./popup.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js??ref--2!./popup.css");
...
// module
exports.push([module.i, ".src-page-popup-popup__Popup--2ZFbv {\n  position: absolute;\n  height: 0;\n  width: 0;\n  display: flex;\n  justify-content: center;\n  align-items: end;\n  z-index: 99999;\n}\n\n.src-page-popup-popup__popupContainer--13fGR {\n  padding-bottom: 0.75em;\n}\n\n.src-page-popup-popup__actionButtonWrapper--28t9d {\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  padding: 0.2em;\n  background: #222;\n  border-radius: 0.5em;\n  box-shadow: 0px 1px 4px 2px #22222240;\n}\n\n.src-page-popup-popup__actionButtonWrapper--28t9d::before {\n  z-index: -1;\n  position: absolute;\n  content: '';\n  top: -1em;\n  width: 0;\n  height: 0;\n  border-radius: 0.25em;\n  border-left: 0.5em solid transparent;\n  border-right: 0.5em solid transparent;\n  border-top: 0.75em solid #222;\n}\n\n.src-page-popup-popup__actionButtonWrapper--28t9d > * {\n  margin: 2px;\n}\n\n.src-page-popup-popup__actionButton--3xIsk {\n  padding: 0;\n  font-size: 125%;\n  display: flex;\n  background: none;\n  border: none;\n}\n\n.src-page-popup-popup__actionButton--3xIsk svg {\n  height: 1.5em;\n  width: 1.5em;\n  filter: invert(1);\n}\n\n.src-page-popup-popup__colorSelector--3m0LX {\n  margin-right: 3px;\n  -webkit-appearance: none;\n  -moz-appearance: none;\n  text-indent: 0;\n  text-overflow: '';\n  border: 0;\n  border-radius: 4px;\n  padding: 2px;\n  font-size: 125%;\n}\n\nbutton:hover,\n.src-page-popup-popup__colorSelector--3m0LX:hover {\n  filter: brightness(0.75);\n}\n", ""]);

// exports
exports.locals = {
	"Popup": "src-page-popup-popup__Popup--2ZFbv",
	"popupContainer": "src-page-popup-popup__popupContainer--13fGR",
	"actionButtonWrapper": "src-page-popup-popup__actionButtonWrapper--28t9d",
	"actionButton": "src-page-popup-popup__actionButton--3xIsk",
	"colorSelector": "src-page-popup-popup__colorSelector--3m0LX"
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["selectionBox"] = selectionBox;
/* harmony export (immutable) */ __webpack_exports__["clientRect"] = clientRect;
/* harmony export (immutable) */ __webpack_exports__["setIcon"] = setIcon;
/* harmony export (immutable) */ __webpack_exports__["getCurrentTab"] = getCurrentTab;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_logger__ = __webpack_require__(1);
/* global browser */
...
class Storage {
  ...
  constructor(writeDelay) {
    this.logger = new __WEBPACK_IMPORTED_MODULE_0__util_logger__["default"]('storage');
...
/* harmony export (immutable) */ __webpack_exports__["default"] = Storage;
...
/***/ })
/******/ ]);
//# sourceMappingURL=highlight-we.page.bundle.js.map